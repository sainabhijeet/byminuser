class CartSeller {
  ...
  CartSeller({this.id="", this.name="", required this.cartSellerItemList});
}
...
class CartSellerItem {
  ...
  CartSellerItem(
      {this.id="", this.cart_item_id="", this.name="", this.image="", this.price=0,this.quantity=0,this.currency_symbol="\$"});
}
