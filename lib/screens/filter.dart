...
import 'package:byminuser/screens/seller_details.dart';
...
class _FilterState extends State<Filter> {
  ...
  List<dynamic> _filterBrandList = <dynamic>[];
  bool _filteredBrandsCalled = false;
  // List<dynamic> _filterCategoryList = List();
  List<dynamic> _filterCategoryList = <dynamic>[];
  ...
  fetchProductData() async {
    ...
    _productList.addAll(productResponse.products as Iterable);
  ...
  List<DropdownMenuItem<WhichFilter>> buildDropdownWhichFilterItems(List which_filter_list) {
    List<DropdownMenuItem<WhichFilter>> items = <DropdownMenuItem<WhichFilter>>[];
