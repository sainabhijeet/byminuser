...
class _LoginState extends State<Login_new> {
...
/*  onPressedFacebookLogin() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.white, body: loginWithEmail());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Center(
                        ...
                        style:
                            TextStyle(color: MyTheme.medium_grey, fontSize: 12),
                      )),
                    ),
                    Padding(
