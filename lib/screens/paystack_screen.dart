...
class _PaystackScreenState extends State<PaystackScreen> {
  ...
  onPaymentSuccess(payment_details) async{
    ...
    if(paystackPaymentSuccessResponse.result == false ){
      print("c");
      Toast.show(paystackPaymentSuccessResponse.message.toString(), textStyle: context,
          duration: Toast.lengthLong, gravity: Toast.center);
      Navigator.pop(context);
      return;
    }
  ...
  buildBody() {
    ...
    String initial_url =
        "${AppConfig.BASE_URL}/paystack/init?payment_type=${widget.payment_type}&order_id=${_order_id}&amount=${widget.amount}&user_id=${user_id.$}";
