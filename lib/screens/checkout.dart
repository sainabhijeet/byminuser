import 'package:byminuser/screens/paypal_screen.dart';
import 'package:byminuser/screens/paystack_screen.dart';
import 'package:byminuser/screens/razorpay_screen.dart';
import 'package:byminuser/screens/sslcommerz_screen.dart';
import 'package:byminuser/screens/stripe_screen.dart';
...
class _CheckoutState extends State<Checkout> {
  ...
  onCouponApply() async {
    ...
    if (couponApplyResponse.result == false) {
      ToastComponent.showDialog(couponApplyResponse.message.toString(), context,
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  onCouponRemove() async {
    ...
    if (couponRemoveResponse.result == false) {
      ToastComponent.showDialog(couponRemoveResponse.message.toString(), context,
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
